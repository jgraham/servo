...
impl<'a> CanvasPaintTask<'a> {
    fn new(size: Size2D<i32>,
           webrender_api: Option<webrender_traits::RenderApi>) -> CanvasPaintTask<'a> {
    ...
    pub fn start(size: Size2D<i32>,
                 webrender_api: Option<webrender_traits::RenderApi>) -> (IpcSender<CanvasMsg>, Sender<CanvasMsg>) {
        ...
        spawn_named("CanvasTask".to_owned(), move || {
            let mut painter = CanvasPaintTask::new(size, webrender_api);
            loop {
